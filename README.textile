...
A simple online shop selling downloadable products. Users can pay for the products using credit card or through PayPal.  Initially, it supports both English and Chinese(zh-hk).  It can be extended for other languages.
...
** Item may have variations, which have different prices. For example a book can be a simple text file or colorful pdf file.
